 ...
 * gui (design system) → IAM (identity) → Base (data). Bistro Site paints its own
 * warm palette (src/theme.ts) on top of the light base theme; swap `defaultTheme`
 * or wrap subtrees in <Theme> to change the gui primitives' default colors.
 */
